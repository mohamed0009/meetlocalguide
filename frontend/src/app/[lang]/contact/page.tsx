...
export default function ContactPage() {
  return (
    <section className="shell py-14">
      ...
      <h1 className="brand-font mt-3 text-4xl font-extrabold">Talk with our travel concierge team</h1>
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-2">
        ...
        <form className="glass-card rounded-2xl p-6">
          <label className="mb-3 block text-sm">
            ...
            <input className="dark-input w-full rounded-xl px-3 py-2" required />
          </label>
          <label className="mb-3 block text-sm">
            <span className="mb-1 block">Email</span>
            <input type="email" className="dark-input w-full rounded-xl px-3 py-2" required />
          </label>
          <label className="mb-4 block text-sm">
            <span className="mb-1 block">Message</span>
            <textarea className="dark-input min-h-32 w-full rounded-xl px-3 py-2" required />
          </label>
          <button className="glow-btn rounded-xl px-5 py-2.5 text-sm" type="submit">Send Message</button>
        </form>
      </div>
    </section>
  );
